...
`Dev Tools:      Git · GitHub · VSCode · Linux · Bash · Spring · Swing GUI`
...
🧾 Validates required fields | 💾 Saves records in a `.txt` file | 🌸 Custom UI components | 💻 Pure Java (no dependencies)
